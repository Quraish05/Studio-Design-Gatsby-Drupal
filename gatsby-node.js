...
exports.createSchemaCustomization = async ({ actions }) => {
  ...
  actions.createTypes(/* GraphQL */ `
    ...
    interface NewHomepageBlock implements Node {
      id: ID!
      blocktype: String
    }
    ...
    interface NewHomepage implements Node {
      id: ID!
      title: String
      content: [NewHomepageBlock]
    }
  ...
  actions.createTypes(/* GraphQL */ `
    ...
    type node__homepage_cta implements Node & HomepageBlock & HomepageCta
      ...
      links: [HomepageLink]
        @link(by: "id", from: "relationships.field_links___NODE")
      demonstration: String @proxy(from: "field_demonstration")
    }
    ...
    type node__new_homepage implements Node & NewHomepage @dontInfer {
      id: ID!
      title: String
      content: [NewHomepageBlock]
        @link(by: "id", from: "relationships.field_new_homepage_content___NODE")
    }
  `)
  ...
  actions.createTypes(`
    ...
    interface NewHomepageHero implements Node & NewHomepageBlock {
      id: ID!
      blocktype: String
      bannerDesc: String
      bannerTitle: String
  ...
  actions.createTypes(`
    type node__homepage_banner implements Node & HomepageBanner & HomepageBlock @dontInfer {
      ...
      blocktype: String @blocktype
      heading: String
      bannerText: String! @proxy(from: "field_banner_text")
      bannerdata: String! @proxy(from: "field_bannerdata")
      demofield: String! @proxy(from: "field_demofield")
    }

    type node__new_homepage_hero implements Node & NewHomepageHero & NewHomepageBlock @dontInfer {
      id: ID!
      blocktype: String @blocktype
      bannerDesc: String! @proxy(from: "field_homepage_banner_descriptio")
      bannerTitle: String! @proxy(from: "field_homepage_banner_title")
    }
  `)
}
